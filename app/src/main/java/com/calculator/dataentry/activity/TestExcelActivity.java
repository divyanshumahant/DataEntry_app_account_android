...
import com.calculator.dataentry.model.InvoiceData;
import com.calculator.dataentry.model.Invoices;
        ...
        public void loadData() {
                ...
                for(int i = -1; i < rows; i ++) {
                        ...
                        if (i > -1) {
                                ...
                                tv3b.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
                                        LayoutParams.WRAP_CONTENT));
                        ...
                        layAmounts.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));


                        final TextView tv4 = new TextView(this);
                        if (i == -1) {
                                tv4.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                                        LayoutParams.MATCH_PARENT));
                        ...
                        if (i > -1) {
                                ...
                                tv4b.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                                        LayoutParams.WRAP_CONTENT));
                        ...
                        if (i > -1) {
                                ...
                                LayoutParams tvSepLay = new LayoutParams(LayoutParams.MATCH_PARENT,
                                        LayoutParams.WRAP_CONTENT);
                                tvSepLay.span = 4;
