...
import com.calculator.dataentry.adapter.ImageAdapter;
...
public class userImageActivity extends AppCompatActivity {
    ...
    private final String Type="images";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(userImageActivity.this);
        pd.setMessage("Please Wait..");
        pd.setCancelable(false);
        cd = new ConnectionDetector(userImageActivity.this);
        ...
        floating_action_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              /*  Intent i=new Intent(userImageActivity.this, FormActivity.class);
                startActivity(i);*/
                ...
                alert = new AlertDialog.Builder(userImageActivity.this);
        ...
        recyclerView.addItemDecoration(new DividerItemDecoration(userImageActivity.this, LinearLayoutManager.VERTICAL));
        recyclerView.setLayoutManager(new LinearLayoutManager(userImageActivity.this,LinearLayoutManager.VERTICAL,false));
    }
    ...
    public void sendData(String token,String name, String mobile, String email, String type) {
        if (!cd.isConnectingToInternet()) {
            Toast.makeText(userImageActivity.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
        } else {
            pd.show();
            ...
            call.enqueue(new Callback<formDataModel>() {
                ...
                public void onResponse(Call<formDataModel> call, retrofit2.Response<formDataModel> response) {
                    ...
                    if (response.body().status.equalsIgnoreCase("success")){
                        ...
                        Toast.makeText(userImageActivity.this, "Try Again", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<formDataModel> call, Throwable t) {
                    ...
                    call.cancel();
                    Toast.makeText(userImageActivity.this, "please try again... !", Toast.LENGTH_SHORT).show();
                    pd.dismiss();
                }
            });
        }
                ...
                public void onResponse(Call<formDataModel> call, retrofit2.Response<formDataModel> response) {
                    ...
                    if (response.body().status.equalsIgnoreCase("userRecyclerBin")){
                        if (dialog!=null)
                            dialog.dismiss();
                        notifyAda(position);
                        Toast.makeText(userImageActivity.this, "Move to Recyclebin Successfully", Toast.LENGTH_SHORT).show();
                ...
                public void onResponse(Call<formDataModel> call, retrofit2.Response<formDataModel> response) {
                    ...
                    if (response.body().status.equalsIgnoreCase("succes")){
                     ...
                     /*   UserModel.userDetails =new UserModel.userDetails();
                        ...
                        Toast.makeText(userImageActivity.this, "Update Details", Toast.LENGTH_SHORT).show();
            ...
            call.enqueue(new Callback<UserModel>() {
                ...
                public void onResponse(Call<UserModel> call, retrofit2.Response<UserModel> response) {
                    ...
                    if (response.body().status.equalsIgnoreCase("success")){
                        ...
                        adapter=new ImageAdapter(userImageActivity.this,listData);
