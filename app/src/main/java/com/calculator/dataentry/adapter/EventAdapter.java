...
public class EventAdapter extends ArrayAdapter {
    ...
    public EventAdapter(Context context, ArrayList<AddEventModel> al) {
        super(context, R.layout.event_item_list, al);
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.event_item_list, parent, false);
       ...
       // vh.tvLocation.setText(lm.getLocation());
        ...
        vh.tvUpdate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    showdialog(lm.getName(),sdate,lm.getId(),pos,lm.getStatus());
            }
        });
    ...
    public void showdialog(final String tit, String det, final String id,final int posi,final String status){
                    ...
                    new android.app.AlertDialog.Builder(context)
                            ...
                            .setPositiveButton("Yes",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            setPriorityInterface.setPriorityEvent(sd.getTOKEN(),title,status,sfinal,id,rdtae,posi,"update");
                                        }
                                    }).setNegativeButton("No", null).show();
