...
import com.calculator.dataentry.activity.PhotoGalleryActivity;
import com.calculator.dataentry.activity.userImageActivity;
...
public class ImageAdapter extends RecyclerView.Adapter<DataListAdapter.ViewHolder>{
    private List<UserModel.userDetails> listdata;
    private List<UserModel.userDetails> searchList;
    private userImageActivity dataListActivity;
    private Context context;
    private AlertDialog dialog;
    private AlertDialog.Builder  alert;
    SessionManagment sd;
    // RecyclerView recyclerView;
    public ImageAdapter(Context context, List<UserModel.userDetails> listdata) {
        this.context = context;
        this.dataListActivity = (userImageActivity) context;
    ...
    public DataListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        DataListAdapter.ViewHolder viewHolder = new DataListAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(DataListAdapter.ViewHolder holder, final int position) {
        ...
        holder.linearId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(context, PhotoGalleryActivity.class);
                in.putExtra("id",myListData.id);
                in.putExtra("name",myListData.name);
                in.putExtra("mobile",myListData.mobile);
                in.putExtra("email",myListData.email);
